...
import com.smushytaco.illegal_substances_that_you_should_not_do_in_real_life_craft.drug_items.CannabisInABluntItem
import com.smushytaco.illegal_substances_that_you_should_not_do_in_real_life_craft.drug_items.CrackItem
import com.smushytaco.illegal_substances_that_you_should_not_do_in_real_life_craft.drug_items.HeroineInANeedleItem
import com.smushytaco.illegal_substances_that_you_should_not_do_in_real_life_craft.drug_items.LineOfCocaineItem
import com.smushytaco.illegal_substances_that_you_should_not_do_in_real_life_craft.tools.material.CustomToolMaterial
import com.smushytaco.illegal_substances_that_you_should_not_do_in_real_life_craft.tools.KnifeToolItem
import com.smushytaco.illegal_substances_that_you_should_not_do_in_real_life_craft.tools.SpoonToolItem
...
object IllegalSubstancesThatYouShouldNotDoInRealLifeCraft : ModInitializer {
    private const val MOD_ID = "illegal_substances_that_you_should_not_do_in_real_life_craft"
    ...
    private val DRUGS_GROUP = FabricItemGroupBuilder
        .build(Identifier(MOD_ID, MOD_ID)) { ItemStack(CANNABIS_IN_A_BLUNT) }
    // Cannabis
